...
$(".dropBtn").click(function () {
  var dropdwonContent = $(".dropdown_content");
  // 아이콘 버전
  // var ico = $('.ico');

  if (dropdwonContent.hasClass("is-active")) {
    dropdwonContent.removeClass("is-active");
    $(this).removeClass("rotate");
    // ico.removeClass('rotate');
  } else {
    dropdwonContent.addClass("is-active");
...
$(window).click(function (event) {
  if (!$(event.target).closest(".dropBtn").length) {
    $(".dropdown_content").removeClass("is-active");
